...
- **Debugging**: Visualize agent runs to understand decision-making
- **Performance Analysis**: Track response times and token usage
- **Quality Improvement**: Review prompts and responses to improve agent prompts
- **Model Comparison**: Compare different LLM providers or versions for your agents