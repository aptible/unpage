...
- [Google Cloud](/plugins/gcp): Provides access to Compute Engine instances, Cloud SQL databases, Cloud Storage buckets, and more from Google Cloud Platform
...
- [Papertrail](/plugins/papertrail): Retrieves logs from the Papertrail service (DEPRECATED)
- [SolarWinds](/plugins/solarwinds): Retrieves logs from the SolarWinds service
