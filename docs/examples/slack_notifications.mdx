...
Your team receives alerts from Datadog, Grafana, or other monitoring tools. You want to:
- Automatically post alerts to a Slack channel
- Enrich alerts with additional context from your infrastructure
- Include relevant metrics, logs, or remediation steps
- Reduce time spent manually investigating and communicating about incidents
...
Make sure your Slack plugin is configured with the webhook URL. Run:
